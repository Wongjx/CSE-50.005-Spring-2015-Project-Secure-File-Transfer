...
public class Server {
	...
	public Server() throws IOException, NoSuchAlgorithmException, InvalidKeySpecException, CertificateException, InvalidKeyException, NoSuchProviderException, SignatureException, NoSuchPaddingException{
...
class clientListenerThread implements Runnable{
	...
	public clientListenerThread(Server server,Socket socket) throws IOException{
